 ...
 */
package com.example.forecast.app.data;
...
public class WeatherContract {
	...
	public static final String CONTENT_AUTHORITY = "com.example.forecast.app";
	// Use Content Authority as the base of all the URI's with which apps will
    ...
    public static final class LocationEntry implements BaseColumns {
        ...
        // Location setting stored as a string that will be sent to openweathermap
        // as a location
        public static final String COLUMN_LOCATION_SETTING = "location_setting";
        // City name stored as string
        public static final String COLUMN_CITY = "city_name";
        // Latitude Coordinate stored as long
        public static final String COLUMN_LAT = "coord_lat";
        // Longitude Coordinate stored as long
        ...
        public static Uri buildWeatherLocationWithStartDate(
        	...
        	return CONTENT_URI.buildUpon().appendPath(locationSetting)
        			.appendQueryParameter(COLUMN_DATE, 
        					Long.toString(normalizeDate(startDate))).build();
        }
