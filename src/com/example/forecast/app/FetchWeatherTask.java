...
import com.example.forecast.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
    	...
    	if(locationCursor.moveToFirst()){
    		...
    		// Create content values object to hold the data that is to be inserted.
    		...
    		// Resulting URI contains id for the row. Extract locationId from URI
    ...
    String[] convertContentValuesToUXFormat(Vector<ContentValues> cvv) {
        ...
        for ( int i = 0; i < cvv.size(); i++ ) {
            ...
            resultStrs[i] = getReadableDateString(
                    ...
                    " - " + highAndLow;
            Log.v(LOG_TAG, "DATA: " + resultStrs[i]);
        }
        return resultStrs;
    }
...
//                Log.v(LOG_TAG, description + String.valueOf(high) + String.valueOf(low));
            ...
            if ( cVVector.size() > 0 ) {
            	...
            	// As we cannot insert a vector directly, we convert it into an array.
            	ContentValues[] cvArray = new ContentValues[cVVector.size()];
            	cVVector.toArray(cvArray);
            	Log.v(LOG_TAG, "YESSSS");
            	mContext.getContentResolver().bulkInsert(WeatherEntry.CONTENT_URI, cvArray);
            }
            else{
            	Log.v(LOG_TAG, "NOOOOO");
            }
